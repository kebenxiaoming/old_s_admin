...
<div class="header-wrap">
    <div class="header-content">
        ...
        <?php if($userinfo): ?><a href="<?php echo U('Login/logout');?>"  style="background:#541b86">退出</a>
            <a href="" >欢迎 , <?php echo ($userinfo["real_name"]); ?></a>
            <?php else: ?>
...
<div class="swiper-container" id="swiper1">
    <div class="swiper-wrapper">
        <div class="swiper-slide" style="background:url(/Public/Home/img/banner1.jpg) center center"></div>
        <div class="swiper-slide" style="background:url(/Public/Home/img/banner1.jpg) center center"></div>
        <div class="swiper-slide" style="background:url(/Public/Home/img/banner1.jpg) center center"></div>
    </div>
    <!-- 如果需要分页器 -->
    <div class="swiper-pagination" id="my-pagination"></div>
</div>
