...
<div class="cpgl_cplb">
    ...
    <?php if(is_array($groups)): foreach($groups as $key=>$group): ?><table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_nr">
        <tr>
            ...
            <td width="139" align="center"><a href="<?php echo U('User/showGroup',array('group_id'=>$group['group_id']));?>"><img src="/Public/Admin/images/zxj.jpg" width="31" height="27" /></a>&nbsp;&nbsp;&nbsp;
                <a href="<?php echo U('Group/edit',array('group_id'=>$group['group_id']));?>"><img src="/Public/Admin/images/cp_11.jpg" width="27" height="27" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a goto="<?php echo U('Group/del',array('group_id'=>$group['group_id']));?>" class="icon-remove"><img src="/Public/Admin/images/cp_13.jpg" width="27" height="27" /></a></td>
        </tr>
