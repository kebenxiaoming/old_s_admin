		...
		<div class="right_nr">
			<table width="855" border="0" cellspacing="0" cellpadding="0" class="right_nr_bt">
				<tr>
					...
					<td width="130"><div class="cp_xz"><a href="/contact/add.php">批量联络</a></div></td>
...
<div class="cpgl_cplb">
    <script src="/Public/Admin/js/area.js"></script>
    <form method="post" action="">
        <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cptj">
            <tr>
                <td width="106" height="80">登录名</td>
                <td width="749"><input name="user_name" type="text" value="<?php echo ($dealer["user_name"]); ?>" class="cpgl_cptj_mc" style="width: 413px" required="true"></td>
            </tr>
            <tr>
                <td height="80">密码</td>
                <td><input name="password" type="text" class="cpgl_cptj_mc" value="" style="width: 413px" placeholder="不填则默认不修改"></td>
            </tr>
            <tr>
                <td width="106" height="80">经销商名称</td>
                <td width="749"><input name="real_name" type="text" class="cpgl_cptj_mc" value="<?php echo ($dealer["real_name"]); ?>" style="width: 413px" placeholder="例如：青岛市市北经销商***" required="true"></td>
            </tr>
            <tr>
                <td width="106" height="80">所在区域</td>
                <script>
                ...
                <td id="choose_cityarea" province_id="<?php echo ($dealer["province_id"]); ?>" city_id="<?php echo ($dealer["city_id"]); ?>" area_id="<?php echo ($dealer["area_id"]); ?>" ></td>
            </tr>
            <tr>
                <td height="80">联系方式</td>
                <td><input name="mobile" type="text" class="cpgl_cptj_mc" style="width: 413px" value="<?php echo ($dealer["mobile"]); ?>" placeholder="请填写手机号" required="true"></td>
            </tr>
