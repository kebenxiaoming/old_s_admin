...
<div class="cpgl_cplb">
    <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_bt">
        <tr>
            <td width="138" height="60" align="center">id</td>
            <td width="132" align="center">分类名称</td>
            <td width="454" align="center">创建时间</td>
            <td width="131" align="center">操作</td>
        </tr>
    </table>
    <?php if(is_array($categories)): foreach($categories as $key=>$category): ?><table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_nr">
        <tr>
            <td width="139" height="60" align="center"><?php echo ($category["id"]); ?></td>
            <td width="130" align="center"><?php echo ($category["category_name"]); ?></td>
            <td width="455" align="center"><?php echo (date("y-m-d H:i:s",$category["createtime"])); ?></td>
            <td width="131" align="center"><a href="<?php echo U('Product/category_edit',array('category_id'=>$category['id']));?>"><img src="/Public/Admin/images/cp_11.jpg" width="31" height="27" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a goto="<?php echo U('Product/category_del',array('category_id'=>$category['id']));?>" class="icon-remove"><img src="/Public/Admin/images/cp_13.jpg" width="27" height="27" /></a></td>
        </tr>
