    ...
    <form method="post" action="">
        <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cptj">
            <tr>
                ...
                <td width="749"><input name="user_name" type="text" value="<?php echo ($_POST["user_name"]); ?>" class="cpgl_cptj_mc" style="width: 413px" required="true"></td>
            </tr>
            <tr>
                <td height="80">密码</td>
                <td><input name="password" type="text" class="cpgl_cptj_mc" value="<?php echo ($_POST["password"]); ?>" style="width: 413px" required="true"></td>
            </tr>
            <tr>
                <td width="106" height="80">经销商名称</td>
                <td width="749"><input name="real_name" type="text" class="cpgl_cptj_mc" value="<?php echo ($_POST["real_name"]); ?>" style="width: 413px" placeholder="例如：青岛市市北经销商***" required="true"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input name="mobile" type="text" class="cpgl_cptj_mc" style="width: 413px" value="<?php echo ($_POST["mobile"]); ?>" placeholder="请填写手机号" required="true"></td>
            </tr>
