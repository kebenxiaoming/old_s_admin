...
<?php if($user_info['user_type']==0): ?><table width="855" border="0" cellspacing="0" cellpadding="0" class="right_nr_sy_bt">
    <tr>
        <td width="21"><img src="<<?php echo ($smarty["const"]["ADMIN_URL"]); ?>>/assets/images/sy_06.jpg" width="4" height="18" /></td>
        <td width="834">快捷菜单</td>
    </tr>
</table>
<div class="right_nr_kj_cd"><a href="<?php echo U('Index/competition_inst');?>">大赛简介</a><a href="<?php echo U('Dealer/add');?>">添加经销商</a><a href="<?php echo U('Designer/add');?>">添加设计师</a><a href="<?php echo U('Contact/addMsg');?>">新增联络</a></div><?php endif; ?>
...
<table width="855" border="0" cellspacing="0" cellpadding="0" class="right_nr_zhxx">
    <tr>
        ...
        <?php if($user_info["user_type"] == 1): ?><td width="103" align="center" style="background-color:#f4f4f4">经销商名称</td>
        <?php elseif($user_info["user_type"] == 2): ?>
        <td width="103" align="center" style="background-color:#f4f4f4">设计师名称</td>
        <?php else: ?>
        <td width="103" align="center" style="background-color:#f4f4f4">真实姓名</td><?php endif; ?>
    ...
    <tr>
        <td height="60" align="center"><?php echo ($user_info["user_name"]); ?></td>
        <td align="center"><?php echo ($user_info["real_name"]); ?></td>
        <td align="center"><?php echo ($user_info["mobile"]); ?></td>
        <td align="center"><?php echo ($user_info["email"]); ?></td>
        <td align="center"><?php echo ($user_info["login_time"]); ?></td>
        <td align="center"><?php echo ($user_info["login_ip"]); ?></td>
    </tr>
</table>
</div>
</div>
