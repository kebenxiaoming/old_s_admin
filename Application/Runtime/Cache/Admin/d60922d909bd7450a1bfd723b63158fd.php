...
<div class="cpgl_cplb">
    <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_bt">
        <tr>
            <td width="221" height="60" align="center">经销商名称</td>
            <td width="132" align="center">登录账号</td>
            <td width="128" align="center">手机号</td>
            <td width="139" align="center">创建时间</td>
            <td width="115" align="center">用户组</td>
            <td width="120" align="center">操作</td>
        </tr>
    </table>

    <?php if(is_array($dealers)): foreach($dealers as $key=>$dealer): ?><table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_nr">
        <tr>
            <td width="221" height="48" align="center"><?php echo ($dealer["real_name"]); ?></td>
            <td width="132" align="center"><?php echo ($dealer["user_name"]); ?> </td>
            <td width="128" align="center"><?php echo ($dealer["mobile"]); ?></td>
            <td width="139" align="center"><?php echo date("Y-m-d H:i:s",$dealer['createtime']); ?></td>
            <td width="115" align="center"><?php echo getGroupName($dealer['user_group']); ?></td>
            <td width="120" align="center"><a href="<?php echo U('Dealer/edit',array('user_id'=>$dealer['user_id']));?>"><img src="/Public/Admin/images/cp_11.jpg" width="27" height="27" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a goto="<?php echo U('Dealer/del',array('user_id'=>$dealer['user_id']));?>" class="icon-remove"><img src="/Public/Admin//images/cp_13.jpg" width="27" height="27" /></a></td>
        </tr>
