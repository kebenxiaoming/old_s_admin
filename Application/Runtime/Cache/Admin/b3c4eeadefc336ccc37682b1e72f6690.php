...
<div class="cpgl_cplb">
    ...
    <form method="post" action="">
        <input type="hidden" value="<?php echo ($product["pics"]); ?>" name="pics" id="picsval">
        <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cptj">
            <tr>
                ...
                <td width="749"><div class="cpgl_cptj_xl">
                    <select name="cate_id">
                        <?php if(is_array($categories)): foreach($categories as $key=>$category): if($product['cate_id'] == $category['id']): ?><option value="<?php echo ($category["id"]); ?>" selected><?php echo ($category["category_name"]); ?></option>
                                <?php else: ?>
            ...
            <tr>
                ...
                <td><input name="title" type="text" class="cpgl_cptj_mc" value="<?php echo ($product["title"]); ?>" required="true"></td>
            </tr>
            <tr>
                <td width="106" height="80">产品价格</td>
                <td width="749"><input name="price" value="<?php echo ($product["price"]); ?>" type="text" class="cpgl_cptj_mc" required="true"></td>
            </tr>
            <tr>
                ...
                <td class="cpgl_cptj_sc">
                    ...
                    <div id="preview">
                        <?php if($pics): if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($i % 2 );++$i;?><div style='width:100px;height:100px;float:left;position:relative;margin-right:10px;'><img style='width:100px;height:100px;' src="/Uploads/Picture/<?php echo ($pic["savepath"]); echo ($pic["savename"]); ?>">
            ...
            <tr>
                ...
                <td><input name="sort" type="text" class="cpgl_cptj_mc"  value="<?php echo ($product["sort"]); ?>" placeholder="数字越小越靠前"></td>
            </tr>
            <tr>
                <td height="177" valign="top" style="padding-top:30px;">产品参数</td>
                <td><textarea name="parameter" cols="" rows="" class="cpgl_cptj_cs" required="true"><?php echo ($product["parameter"]); ?></textarea></td>
            </tr>
            <tr>
