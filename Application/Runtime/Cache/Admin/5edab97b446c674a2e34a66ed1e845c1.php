...
<div class="cpgl_cplb">
    <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_bt">
        <tr>
            <td width="130" height="60" align="center">#</td>
            <td width="151" align="center">发送类型</td>
            <td width="164" align="center">手机号</td>
            <td width="136" align="center">内容</td>
            <td width="139" align="center">发送状态</td>
            <td width="130" align="center">发送时间</td>
        </tr>
    </table>
    <?php if(is_array($smss)): foreach($smss as $key=>$sms): ?><table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_nr">
            <tr>
                <td width="130" height="48" align="center"><?php echo ($sms["id"]); ?></td>
                <td width="151" align="center">
                    <?php if($sms['type']==1): ?>验证码
                        <?php else: ?>
                        普通消息<?php endif; ?>
                </td>
                <td width="151" align="center"><?php echo ($sms["mobile"]); ?></td>
                <td width="164" align="center"><?php echo ($sms["content"]); ?></td>
                <td width="136" align="center">
                    <?php if($sms['status']==1): ?>发送成功
                        <?php else: ?>
                        发送失败<?php endif; ?>
                </td>
                <td width="136" align="center"><?php echo date('Y-m-d H:i:s',$sms['createtime']); ?></td>
            </tr>
