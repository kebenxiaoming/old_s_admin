...
<table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_bt">
    <tr>
        <td width="265" height="60" align="center">产品名称</td>
        <td width="151" align="center">产品类别</td>
        <td width="164" align="center">创建时间</td>
        <td width="136" align="center">产品排序</td>
        <td width="139" align="center">操作</td>
    </tr>
</table>
<?php if(is_array($products)): foreach($products as $key=>$product): ?><table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_nr">
    <tr>
        <td width="265" height="48" align="center"><?php echo ($product["title"]); ?></td>
        <td width="151" align="center"><?php echo ($product["category_name"]); ?></td>
        <td width="164" align="center"><?php echo (date("y-m-d H:i:s",$product["createtime"])); ?></td>
        <td width="136" align="center"><?php echo ($product["sort"]); ?></td>
        <td width="139" align="center"><a href="<?php echo U('Product/edit',array('id'=>$product['id']));?>"><img src="/Public/Admin/images/cp_11.jpg" width="27" height="27" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a goto="<?php echo U('Product/del',array('id'=>$product['id']));?>" class="icon-remove"><img src="/Public/Admin/images/cp_13.jpg" width="27" height="27" /></a></td>
    </tr>
