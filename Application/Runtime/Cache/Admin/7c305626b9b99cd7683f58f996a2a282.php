...
<div class="cpgl_cplb">
    <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_bt">
        <tr>
            <td width="138" height="60" align="center">联络时间</td>
            <td width="132" align="center">联络方式</td>
            <td width="454" align="center">描述</td>
            <td width="131" align="center">操作</td>
        </tr>
    </table>
    <?php if(is_array($messages)): $i = 0; $__LIST__ = $messages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$message): $mod = ($i % 2 );++$i;?><table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cplb_nr">
        <tr>
            <td width="139" height="60" align="center"><?php echo date("Y-m-d",$message['createtime']); ?></td>
            <td width="130" align="center">
                <?php if($message['msg_type'] == 1): ?>短信
                    <?php elseif($message['msg_type'] == 1): ?>
                    邮件
                    <?php else: ?>
                    站内信<?php endif; ?>
            </td>
            <td width="455" align="center"><?php echo ($message["msg"]); ?></td>
            <td width="131" align="center"><a href="#"><img src="/Public/Admin/images/zxj.jpg" width="31" height="27" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a goto="#" class="icon-remove"><img src="/Public/Admin/images/cp_13.jpg" width="27" height="27" /></a></td>
        </tr>
