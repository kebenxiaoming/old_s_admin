			...
			<table width="855" border="0" cellspacing="0" cellpadding="0" class="right_nr_bt">
				<tr>
					...
					<td width="574">
						...
						<input value="<?php echo ($search); ?>" type="text" name="search" placeholder="搜索产品" class="cp_ss_sr">
						<input type="button" onclick="formsub();" class="cp_ss_an">
							</form>
					</div>

					</td>
					<td width="130"><div class="cp_xz"><a href="/product/add.php">新增产品</a></div></td>
					<?php elseif($content_header['menu_id'] ==107): ?>
					<div class="cp_ss">
						<form action="" id="search" method="get">
						<input name="user_name"  value="<?php echo ($user_name); ?>" type="text" placeholder="搜索经销商" class="cp_ss_sr">
						<input name="" type="button" onclick="formsub();" class="cp_ss_an">
						</form>
					</div>

					</td>
					<td width="130"><div class="cp_xz"><a href="/dealer/add.php">新增经销商</a></div></td>
					<?php elseif($content_header['menu_id'] ==108): ?>
					<div class="cp_ss">
						<form action="" id="search" method="get">
						<input name="real_name" value="<?php echo ($real_name); ?>" type="text" placeholder="搜索设计师" class="cp_ss_sr">
						<input name="" type="button"  onclick="formsub();" class="cp_ss_an">
						</form>
					</div>
					...
					<td width="130"><div class="cp_xz"><a href="/product/category_add.php">添加分类</a></div></td><?php endif; ?>
				</tr>
			</table>
			<script>
				function formsub(){
