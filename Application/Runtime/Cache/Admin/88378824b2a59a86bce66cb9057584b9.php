    ...
    <div id="myTabContent" class="tab-content">
        <div class="tab-pane active in" id="home">
            ...
            <form id="tab" method="post" action="">
                ...
                <label>模块名称</label>
                <input type="text" name="module_name" value="<?php echo ($currentmodule["module_name"]); ?>" class="input-xlarge" required="true" autofocus="true" >
                <label>模块链接</label>
                <input type="text" name="module_url" value="<?php if($currentmodule['module_url'] == ''): ?>Module/add<?php else: echo ($currentmodule["module_url"]); endif; ?>" class="input-xlarge" required="true">


                <label>模块排序数字(数字越小越靠前)</label>
                <input type="text" name="module_sort" value="<?php echo ($module["module_sort"]); ?>" class="input-xlarge" >
                <label>描述</label>
                <textarea name="module_desc" rows="3" class="input-xlarge"><?php echo ($currentmodule["module_desc"]); ?></textarea>
