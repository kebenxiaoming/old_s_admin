...
<div class="cpgl_cplb">
    ...
    <form action="" method="post">
        <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cptj">
            <tr>
                <td height="80">手机号</td>
                <td><input name="mobile" type="text" class="cpgl_cptj_mc" value="<?php echo ($designer["mobile"]); ?>" placeholder="请输入手机号"  required="true"></td>
            </tr>
            <tr>
                <td width="106" height="80">登录密码</td>
                <td width="749"><input name="password" type="text" class="cpgl_cptj_mc" value="" placeholder="请输入密码"></td>
            </tr>
            <tr>
                <td height="80">姓名</td>
                <td><input name="real_name" type="text" class="cpgl_cptj_mc" value="<?php echo ($designer["real_name"]); ?>" placeholder="请填写您的姓名"  required="true"></td>
            </tr>
            <tr>
                <td height="80">邮箱</td>
                <td><input name="email" type="text" class="cpgl_cptj_mc" value="<?php echo ($designer["email"]); ?>" placeholder="请填写您的邮箱"  required="true"></td>
            </tr>
            <tr>
                ...
                <td id="choose_cityarea" province_id="<?php echo ($designer["province_id"]); ?>" city_id="<?php echo ($designer["city_id"]); ?>" area_id="<?php echo ($designer["area_id"]); ?>"></td>
            </tr>

            <tr>
                <td width="106" height="80">供职企业</td>
                <td><input name="company" type="text" class="cpgl_cptj_mc" value="<?php echo ($designer["company"]); ?>"  placeholder="请填写您供职的企业"  required="true"></td>
            </tr>
